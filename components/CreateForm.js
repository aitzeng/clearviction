    ...
    <div className="h-screen items-center justify-center flex">
      <form className="">
        ...
        <div className="github-url-parent mx-2 my-2">
          <p className="font-bold">Github Repo URL:</p>
        ...
        <button onClick={submitForm} className="mx-2 my-2 px-2 border-2 border-gray-500 bg-gray-200" type="submit">Submit</button>
      </form>
    </div>
  )
};
